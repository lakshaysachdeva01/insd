/*! UniCore 3.19.1 | https://www.unistudio.co | (c) 2023 - 2024 UniStudio | MIT License */ !(function (
  ...
  function $e(t, e) {
    return B(
      B(t).map((t) => (t.hasChildNodes() ? xe(p(t.childNodes), e) : me(t, e)))
    );
  }
  function ye(t) {
    B(t)
  ...
  function ze(t) {
    ...
    return (i, n) => {
      if (A(n)) {
        ...
        return (
          (n =
            "auto" === (n = Qt((i = _(i)), t)) ? i[`offset${e}`] : M(n) || 0) -
          He(i, t)
        );
      }
            ...
            (function (t, e, n, s) {
              return new Promise((o) => {
                ...
                !(function f() {
                  ...
                  (t.scrollTop = Math[e + m > 0 ? "max" : "min"](
                    t.scrollTop,
                    r + (e + m) * p
                  )),
                    1 !== p || (d !== m && u--)
                      ? ((d = m), requestAnimationFrame(f))
                      : o();
                })();
              });
            })(s, f - r, t, c).then(n)
  ...
  function _i(t) {
    ...
    for (let [e, s, o, r] of [
      ...
      const a = n[e] % 1;
      (n[e] = n[s] = i[`client${l(e)}`] - (a ? (a < 0.5 ? -a : 1 - a) : 0)),
        (n[r] = n[e] + n[o]);
    }
    return n;
  }
    ...
    for (const [l, [h, , c, d]] of Object.entries(Hi)) {
      ...
      if ("flip" === r[l]) {
        ...
        const t = Me(e[l]),
          { offset: s } = i;
        f =
          V(V(n[c], u[c], u[d] - n[h]), t[c] - n[h] + s[l], t[d] - s[l]) - n[c];
      }
      a = Wi(a, f, l);
    }
    return a;
  ...
  var sn = {
    ...
    methods: {
      ...
      update() {
        ...
        t.total ||
          (this.stop(),
          this.end || (Vt(this.$el, "countdownend"), (this.end = !0)));
        for (const e of nn) {
  ...
  function an(t, e) {
    return (
      (t = t && !f(t) ? [t] : t), e ? (t ? t.concat(e) : f(e) ? e : [e]) : t
    );
  }
  function ln(t, e) {
    return A(e) ? t : e;
        ...
        for (const e of t)
          for (const i of e)
            lt(i, this.margin, t[0] !== e),
              lt(i, this.firstColumn, e[Xe ? e.length - 1 : 0] === i);
      },
      events: ["resize"],
    },
  };
  ...
  function kn(t, e = !1) {
    ...
    return (
      e && ([i, n] = Be(t)), { top: i, left: n, bottom: i + s, right: n + o }
    );
  }
  ...
  function En(t, e, i, n = 0) {
    const s = An(e, !0),
        ...
        nt(e, Cn),
          await Promise.all(
            Pn(e).map(
              (t, e) =>
                new Promise((s) =>
                  setTimeout(() => se.start(t, r, i / 2, "ease").then(s), e * n)
                )
            )
          ),
          st(e, Cn);
      ...
      h = a(async () => {
        ...
        a !== h &&
          d.push(se.start(e, { height: h }, i / 2 + c.length * n, "ease")),
  ...
  function An(t, e) {
    return (
      e && (t.dataset.transition = 1 + An(t)), P(t.dataset.transition) || 0
    );
  }
  function Dn(t) {
    return Promise.all(
      St(t)
        ...
        .map(
          (t) =>
            new Promise((e) => qt(t, "transitionend transitioncanceled", e))
        )
    );
  }
  function Pn(t) {
  ...
  async function Mn(t, e, i) {
    ...
    try {
      await Promise.all(u),
        n.forEach((t, i) => {
          Q(t, c[i]),
            vt(t) === e && Qt(t, "display", 0 === l[i].opacity ? "none" : "");
        }),
        Q(e, "style", r);
    } catch {
      Q(n, "style", ""),
              ...
              (function (t, e, i) {
                ...
                if (s) {
                  const t = (function (t, e, i) {
                    return [...t].sort(
                      (t, n) =>
                        it(t, e).localeCompare(it(n, e), void 0, {
                          numeric: !0,
                        }) * ("asc" === i || -1)
                    );
                  })(i, s, o);
      ...
      (n || A(o)) &&
        (s
          ? n
            ...
            : (delete i.filter[s],
              (E(i.filter) || "" in i.filter) && (i.filter = { "": n || "" }))
          : (i.filter = { "": n || "" })),
      A(o) || (i.sort = [o, r]),
      i
    );
  ...
  function Kn(t) {
    const e = Lt(t, "touchstart", (e) => {
      if (1 !== e.targetTouches.length || bt(e.target, 'input[type="range"'))
        return;
      let i = Zt(e).y;
      const n = Lt(
        t,
            ...
            return (
              await Promise.all(
                B(t).map((t) => {
                  ...
                  if (!Vt(t, "before" + (n ? "show" : "hide"), [this]))
                  ...
                  return s
                    ? s.then(r, () => (st(t, o), Promise.reject()))
                    : r();
                })
              ),
              !0
  ...
  var os = {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          this.stack &&
            Qt(this.$el, "zIndex", M(Qt(this.$el, "zIndex")) + ss.length);
          const t = [
    ...
    return new Promise((s, o) =>
      qt(t, "show hide", () => {
        ...
        const a = qt(
            ...
            "transitionstart",
            () => {
              qt(i, "transitionend transitioncancel", s, { self: !0 }),
                clearTimeout(l);
            },
            { self: !0 }
          ),
  ...
  function zs(t) {
    t._connected ||
      ((function (t) {
        ...
        for (let e in i)
          e in s && (!o || !n(o, e)) && (!r || !n(r, e)) && (t[e] = i[e]);
      })(t),
      Ns(t, "beforeConnect"),
      (t._connected = !0),
      (function (t) {
  ...
  function js(t, e = {}) {
    (e.data = (function ({ data: t = {} }, { args: e = [], props: i = {} }) {
      f(t) &&
        (t = t
          .slice(0, e.length)
          .reduce((t, i, n) => (w(i) ? m(t, i) : (t[e[n]] = i), t), {}));
      for (const e in t)
      ...
      watch: {
        ...
        navItems(t) {
          for (const e of t) {
            ...
            if (T(t)) {
              ...
              this.list &&
                (this.list.id || (this.list.id = Ks(this, this.list)),
                (s = this.list.id)),
                (n = this.t(t));
        ...
        length(t) {
          ...
          if (this.nav && t !== e) {
            ue(this.nav);
            for (let e = 0; e < t; e++)
              me(this.nav, `<li ${this.attrItem}="${e}"><a href></a></li>`);
          }
        },
      },
      connected() {
      ...
      if (((this.matchMedia = !0), t || e)) {
        ...
        const n = () => {
          (this.matchMedia = this.mediaObj.matches),
            Vt(this.$el, Rt("mediachange", !1, !0, [this.mediaObj]));
        };
      ...
      (e, n) => {
        const [s, o, r] = ko(i, n),
          a = s
            .map(
              (t, e) => (
                (t += r * (o[e] - t)), 3 === e ? M(t) : parseInt(t, 10)
              )
            )
            .join(",");
        e[t] = `rgba(${a})`;
        ...
        const t = this.parallaxTarget,
          ...
          r = this.slides[s],
          {
            ...
            function s(i) {
              at(i, n) && (r(i), a(i)),
                at(i, e) ||
                  (Vt(i, "beforeitemshow", [t]), Vt(i, "itemshow", [t]));
            }
            function o(e) {
            ...
            function r(r) {
              at(r, e) || s(r),
                at(r, i) && o(r),
                at(r, n) ||
                  (Vt(r, "beforeitemhide", [t]), Vt(r, "itemhide", [t]));
            }
            function a(e) {
  ...
  function jo(t, e) {
    return (
      (t &&
        (_e(t).left + (Xe ? Pe(t).width - Pe(e).width : 0)) * (Xe ? -1 : 1)) ||
      0
    );
  }
  function Lo(t, e) {
  ...
  var qo = {
        ...
        return {
          ...
          show(e, n = 0, r) {
            ...
            return (
              ...
              new Promise((t) => {
                l || (l = t),
                  se
                    .start(o, { transform: us(-a * (Xe ? -1 : 1), "px") }, e, h)
                    .then(l, R);
              })
            );
          },
          ...
          translate(n) {
            ...
            Qt(
              o,
              "transform",
              us(V(s - s * n - a, -Fo(o), Pe(o).width) * (Xe ? -1 : 1), "px")
            );
          ...
          percent: () =>
            Math.abs(
              (Qt(o, "transform").split(",")[4] * (Xe ? -1 : 1) + r) / (a - r)
            ),
      ...
      sets({ sets: t }) {
        ...
        for (let t = 0; t < this.length; t++) {
          ...
          e + s > n && (e = 0),
            this.center
              ? e < n / 2 &&
                e + s + Pe(this.slides[Z(+t + 1, this.slides)]).width / 2 >
                  n / 2 &&
                (i.push(+t), (e = n / 2 - s / 2))
    ...
    methods: {
      ...
      updateActiveClasses(t = this.index) {
        ...
        const i = [
          this.clsActive,
          !this.sets || d(this.sets, M(this.index)) ? this.clsActivated : "",
        ];
      ...
      getIndexAt(t) {
        ...
        let i =
            ...
            (this.center
              ? Fo(this.list) -
                (Pe(this.slides[0]).width / 2 + Pe(H(this.slides)).width / 2)
        ...
        (this.tooltip = me(
          ...
          Lt(this.tooltip, "toggled", (t, e) => {
            ...
            const [n, s] = (function (t, e, [i, n]) {
              ...
              return (
                (n =
                  (d(r[0], i) ? r[1] : r[0]).find((t) => s[t] === o[t]) ||
                  "center"),
                [i, n]
              );
                    ...
                    (function (t, e) {
                      return new Promise((i, n) => {
                        ...
                        Lt(s, "load", () => {
                          ...
                          Lt(s, "error", () =>
                            n(m(Error("Network Error"), { xhr: s }))
                          ),
                          Lt(s, "timeout", () =>
                            n(m(Error("Network Timeout"), { xhr: s }))
                          ),
                          s.send(e.data);
                      });
                    })(t, i)
              ...
              this.toggleElement(t, !d(n, t), (t, i) => {
                if ((lt(t, this.clsOpen, i), !1 !== e && this.animation))
                  return (async function (
                    ...
                    const h =
                        L(["marginTop", "marginBottom"], (t) => Qt(i, t)) +
                        Pe(i).height,
                      c = l / h;
                    (n = (s * h + n) * (e ? 1 - c : c)),
                      Qt(a, "height", l),
      ...
      { name: "beforehide", self: !0, handler: "clearTimers" },
      {
        ...
        handler({ target: t }) {
          this.$el === t
            ...
            : ($r =
                null === $r && this.$el.contains(t) && this.isToggled()
                  ? this
                  : $r);
        },
      },
          ...
          if (this.axis === s && d([s, !0], this.stretch)) {
            ...
            Qt(this.$el, {
              [o]:
                (l[r] > h[r]
                  ? l[this.inset ? a : r] -
                    Math.max(Me(this.boundary[n])[r], t[n][r] + e)
                  : Math.min(Me(this.boundary[n])[a], t[n][a] - e) -
                    l[this.inset ? r : a]) - i,
              [`overflow-${s}`]: "auto",
            }),
              this.positionAt(this.$el, this.target, this.boundary);
          ...
          const e = this.getDropdown(t),
            i = () => {
              ...
              Me(this.dropbar, {
                ...
                this.transitionTo(
                  i - Me(this.dropbar).top + M(Qt(t, "marginBottom")),
                  t
                );
            };
            ...
            (!e && !n) ||
              t.forEach((t, s) =>
                t.forEach((t, o) => {
                  let [r, a] = (n && n[s][o]) || [0, 0];
                  e && (a += e * i[s]),
                    Qt(t, "transform", `translate(${r}px, ${a}px)`);
                })
              );
          },
          events: ["scroll", "resize"],
        ...
        read() {
          ...
          if (((t = "calc(" + (r ? "100vh" : `${o}px`)), this.expand)) {
            ...
            !0 === this.offsetBottom
              ...
              : k(this.offsetBottom) &&
                (t += ` - ${Pe(Tt(this.offsetBottom, this.$el)).height}px`);
          }
  ...
  const qr = {
                    ...
                    (na[t] = Te(
                      (
                        qr[
                          (function (t) {
                            return Xe
                              ? z(z(t, "left", "right"), "previous", "next")
                              : t;
                          })(t)
                        ] || qr[t]
                      ).trim()
    ...
    Yr = {
      ...
      beforeConnect() {
        const t =
          at(this.$el, "uc-search-toggle") || at(this.$el, "uc-navbar-toggle");
        if (
          ((this.icon = t
            ? "search-toggle-icon"
    ...
    Kr = {
      ...
      beforeConnect() {
        this.icon =
          "close-" + (at(this.$el, "uc-close-large") ? "large" : "icon");
      },
    },
  ...
  var ua = {
      ...
      computed: {
        fill: ({ fill: t }, e) => t || Qt(e, "--uc-leader-fill-content"),
      },
      connected() {
      ...
      observe: mn({
        ...
        handler(t) {
          ...
          for (const { target: i, isIntersecting: n } of t) {
            e.has(i) ||
              e.set(i, { cls: it(i, "uc-scrollspy-class") || this.cls });
            const t = e.get(i);
        ...
        toggle(t, e) {
          ...
          if (n) {
            if (
              ...
              e
                ? (n.off = qt(t, "animationcancel animationend", i, {
                    self: !0,
                  }))
                : i();
            }
    ...
    Ca = {
      ...
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: n }) {
            if (
              ((this.inactive = !this.matchMedia || !ut(this.$el)),
              this.inactive)
            )
              return;
            ...
            const d = this.overflowFlip ? 0 : Math.max(0, t + c - o),
              ...
              m =
                !1 === this.end
                  ? a
                  : Math.min(a, Ta(this.end, this.$el, u + t, !0) - f - c + d);
            return (
              (n =
                a &&
                !this.showOnUp &&
          ...
          write({ height: t, width: e, margin: i, offset: n, sticky: s }) {
            if (
              ((this.inactive || s || !this.isFixed) && Aa(this.$el),
              this.inactive)
            )
              return;
            s &&
              ((t = e = i = 0), Qt(this.$el, { position: "sticky", top: n }));
      ...
      methods: {
        ...
        setActive(t) {
          ...
          (this.active = t),
            t
              ? (rt(this.target, this.clsInactive, this.clsActive),
  ...
  function Ta(t, e, i, n) {
    ...
    if (T(t) || (k(t) && t.match(/^-?\d/))) return i + je(t, "height", e, !0);
    {
      ...
      return (
        Me(i).bottom -
        (n && null != i && i.contains(e) ? M(Qt(i, "paddingBottom")) : 0)
      );
    }
  }
  function Ea(t) {
  ...
  var Fa = {
    ...
    computed: {
      target: ({ target: t }, e) => ((t = Et(t || e.hash, e)).length ? t : [e]),
    },
    connected() {
      d(this.mode, "media") ||
      ...
      async toggle(t) {
        ...
        if (
          (tt(this.$el, "aria-expanded") &&
            Q(this.$el, "aria-expanded", !this.isToggled(this.target)),
          !this.queued)
        )
