        ...
        });
      {
        ...
        e || (e = i),
          ...
          r.pagination &&
            ...
            (r.pagination.el = [...e.querySelectorAll(r.pagination.el)]),
          r.thumbs &&
            r.thumbs.connect &&
            "string" == typeof r.thumbs.connect &&
            (r.thumbs.connect = [...e.querySelectorAll(r.thumbs.connect)]),
          r.progress &&
            r.progress.bar &&
            "string" == typeof r.progress.bar &&
            (r.progress.bar = [...e.querySelectorAll(r.progress.bar)]),
          delete r.parent;
      }
    ...
    r = (n, o = "data-uc-swiper") => {
      ...
      const r = () => {
        ...
        e.update(),
          ...
          window.addEventListener("load", () => e.update(), { once: !0 });
      };
